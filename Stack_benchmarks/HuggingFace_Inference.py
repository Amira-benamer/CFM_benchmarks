...
class LLM_HuggingFace:
    def __init__(self, model_name, model_path=None, hourly_rate=0.227):
        ...
        # Directory for saving model/results
        self.save_dir = os.path.join("results", model_name.replace("/", "_"))
    ...
    def predict(self, texts, max_new_tokens=64):
        ...
        result_path = os.path.join(self.save_dir, f"result_{timestamp}.json")
...
if __name__ == '__main__':
    ...
    try:
        ...
        # Optionally save model and tokenizer
        llm.save_model_and_tokenizer()
